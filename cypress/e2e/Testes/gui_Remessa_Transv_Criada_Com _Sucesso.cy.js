...
describe('Teste E2E - Realizando a criação de remessa com sucesso', () => {
    it('Fluxo da criação de remessa', () => {
            ...
            // Aguarde 2 s
            cy.wait(2000);
            //Digitando Transportadora 
            cy.get('#input-225').type('Transv')
            //Clicando em Remessas
            cy.get(':nth-child(6) > .font-weight-bold').click() 
            //Criar Remessa
            ...
            cy.get('#input-1043').click({ force: true });
            ...
            cy.get('#input-1051').invoke('val', dataAtualFormatada);
            
            // Aguardando 3 segundos 
            cy.wait(3000);

            // Clicando no modal calendário
            cy.get('#input-1055').click()
            ...
            // Definindo a data atual no campo de entrada de data
            cy.get('#input-1055').invoke('val', dataAtualFormatada);
