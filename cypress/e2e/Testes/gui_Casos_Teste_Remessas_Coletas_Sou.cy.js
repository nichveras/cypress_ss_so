...
describe('Teste E2E - Realizando a criação de remessa com sucesso', () => {
    it('Fluxo da criação de remessa', () => {
            ...
            // Selecionando pedido 
            cy.get('[aria-label=""] > .v-data-table__checkbox > .v-input--selection-controls__input > .v-input--selection-controls__ripple').click()

            //Termo de Ciência do comprimento dos pedidos
